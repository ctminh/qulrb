...
if __name__ == "__main__":
    ...
    # test_cases = [
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case0.csv", 347, 0),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case1.csv", 73, 1),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case1.csv", 354, 1),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case2.csv", 107, 2),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case2.csv", 352, 2),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case3.csv", 49, 3),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case3.csv", 348, 3),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case4.csv", 71, 4),
    #     ("../experiments/varied_imb_ratios/input_lrp/input_table_varied_imbs_case4.csv", 353, 4),
    # ]
    
    # test_cases = [
        # ("../experiments/varied_num_procs/input_lrp/input_table_4nodes.csv", 90,4),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_4nodes.csv", 300,4),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_8nodes.csv", 163,8),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_8nodes.csv", 700,8),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_16nodes.csv", 350,16),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_16nodes.csv", 1499,16),
    #     ("../experiments/varied_num_procs/input_lrp/input_table_32nodes.csv", 644,32),#heavy
    #     ("../experiments/varied_num_procs/input_lrp/input_table_32nodes.csv", 3098,32), #heavy
    #     ("../experiments/varied_num_procs/input_lrp/input_table_64nodes.csv", 2353,64), #heavy
    #     ("../experiments/varied_num_procs/input_lrp/input_table_64nodes.csv", 6302,64), #heavy
    # ]
    
    test_cases = [
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_8tasks.csv", 11, 8),
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_8tasks.csv", 56, 8),
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_16tasks.csv", 53, 16),
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_16tasks.csv", 112, 16),
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_32tasks.csv", 43, 32), 
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_32tasks.csv", 224, 32), #1
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_64tasks.csv", 87, 64),
        # ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_64tasks.csv", 448, 64),
        
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_128tasks.csv", 196, 128),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_128tasks.csv", 896, 128),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_256tasks.csv", 349, 256),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_256tasks.csv", 1792, 256), #2
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_512tasks.csv", 696, 512),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_512tasks.csv", 3584, 512),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_1024tasks.csv", 1407, 1024),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_1024tasks.csv", 7168, 1024),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_2048tasks.csv", 2800, 2048),
        ("../experiments/varied_num_tasks/input_lrp/input_table_8nodes_2048tasks.csv", 14336, 2048),
    ]
    
    #TODO remember to check the experiment_id
    experiment_id = 0
