...
if __name__ == "__main__":
    ...
    for algorithm in list_algorithms:
        ...
        for npro in num_procs:
            ...
            input = input_folder + 'input_table_' + str(npro) + 'nodes.csv'
    ...
    print("-------------------------------------------")
    print("Write the table of imb ratios after rebalancing to csv: ./data_varied_numprocs_imb_ratios.csv")
    df_imb_ratios.to_csv('./data_varied_numprocs_imb_ratios.csv', index=False)
    print("-------------------------------------------\n")

    print("Write the table of speedup after rebalancing to csv: ./data_varied_numprocs_speedups.csv")
    df_speedups.to_csv('./data_varied_numprocs_speedups.csv', index=False)
    print("-------------------------------------------\n")
